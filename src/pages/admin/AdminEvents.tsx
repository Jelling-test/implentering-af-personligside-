...
import { Plus, Pencil, Trash2, CalendarDays, Clock, MapPin, Loader2, X, Check } from 'lucide-react';
...
const AdminEvents = () => {
  ...
  const startEdit = (event: CampEvent) => {
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="title">Titel (dansk) *</Label>
                  <Input
                    id="title"
                ...
                <div className="space-y-2">
                  <Label htmlFor="title_en">Titel (engelsk)</Label>
                  <Input
                    id="title_en"
                    value={editingEvent.title_en || ''}
                    onChange={(e) => setEditingEvent({ ...editingEvent, title_en: e.target.value })}
                    placeholder="F.eks. Pancake Evening"
                  />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="description">Beskrivelse (dansk) *</Label>
                <Textarea
                  id="description"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="event_time">Starttid *</Label>
                  <Input
                    id="event_time"
                    type="time"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="target_group">Målgruppe</Label>
                  <select
                    id="target_group"
                ...
                <div className="space-y-2">
                  <Label htmlFor="registration_place">Tilmelding</Label>
                  <select
