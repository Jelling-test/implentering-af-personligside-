...
const AdminHytter = ({ isStaffView = false }: AdminHytterProps) => {
  ...
  const fetchDistributionBoards = async () => {
    try {
      const { data, error } = await (supabase as any)
  ...
  const handleEdit = (cabin: Cabin) => {
    ...
    setFormData({
      ...
      distribution_board_id: cabin.distribution_board_id || "",
    });
  ...
  const handleSaveNew = async () => {
    ...
    try {
      const { error } = await (supabase as any).from("cabins").insert({
        ...
        distribution_board_id: formData.distribution_board_id && formData.distribution_board_id !== "none" ? formData.distribution_board_id : null,
        is_active: true,
      });
          ...
          <Dialog open={showAddModal} onOpenChange={setShowAddModal}>
            <DialogContent>
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="distribution_board">Undertavle</Label>
                  <Select
                    value={formData.distribution_board_id}
                    onValueChange={(value) =>
                      setFormData({ ...formData, distribution_board_id: value })
                    }
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      <SelectItem value="none">Ingen undertavle</SelectItem>
          ...
          <Dialog open={showEditModal} onOpenChange={setShowEditModal}>
            <DialogContent>
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit_distribution_board">Undertavle</Label>
                  <Select
                    value={formData.distribution_board_id}
                    onValueChange={(value) =>
                      setFormData({ ...formData, distribution_board_id: value })
